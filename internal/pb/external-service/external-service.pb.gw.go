...
/*
Package external_service is a reverse proxy.
...
func RegisterFooServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server FooServiceServer) error {
	...
	mux.Handle("GET", pattern_FooService_GetFoo_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/external_service.FooService/GetFoo", runtime.WithHTTPPathPattern("/v1/foos/{id}"))
		if err != nil {
...
func RegisterFooServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client FooServiceClient) error {
	...
	mux.Handle("GET", pattern_FooService_GetFoo_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/external_service.FooService/GetFoo", runtime.WithHTTPPathPattern("/v1/foos/{id}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
